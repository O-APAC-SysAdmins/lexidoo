              ...
              (list (plain-file "rc"
                                (string-join
                                  (list "eval \"$(guix package --search-paths -p ~/.config/guix/current -p ~/.guix-profile -p ~/.guix-home/profile -p /run/current-system/profile)\""
                                        ...
                                        "fish_add_path -P -a ~/git/star/bin"
                                        "fish_add_path -P -a ~/git/star/share/perl6/site/bin"
                                        "fish_add_path -P -a ~/git/star/share/perl6/vendor/bin"
                                        "fish_add_path -P -a ~/git/star/share/perl6/core/bin"
